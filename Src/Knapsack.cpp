...
********************************************************************************
  ...
  INPUTS:  1) MAXIMUM WEIGHT, i.e. a positive integer giving the maximum value
              permitted for the sum of the weights of all selected items.
 ...
 * ================================================================================================================== */
  ...
  /* if the given node has a bound greater than the current maximum profit,
     then add this node to the state space tree  */
  ...
  {
    int vi , // advance the iterator
        totweight ; // of items in the calculated bound
...
using namespace mhs_knapsack ;

/* assemble and sort the given items then launch bestFirstSearch() to find the optimal set  */
int main( int argc, char *argv[] )
{
  ...
  sleep( 3 ); // pause to review setup printout
